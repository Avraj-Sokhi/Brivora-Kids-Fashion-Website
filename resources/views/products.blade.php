...
<section class="products" id="product-list">
  ...
  <div class="card" data-category="accessories" data-price="10">
    ...
    <div class="card-body">
      ...
      <!-- LOW STOCK -->
      <p class="stock" style="color: orange; font-weight: bold;">Low Stock</p>
  ...
  <div class="card" data-category="accessories" data-price="8">
    ...
    <div class="card-body">
      ...
      <button class="btn" style="background: grey;" disabled>Out of Stock</button>
    </div>
  </div>
  ...
  <div class="card" data-category="accessories" data-price="18">
    ...
    <div class="card-body">
      ...
      <!-- IN STOCK -->
      <p class="stock" style="color: green; font-weight: bold;">In Stock</p>
