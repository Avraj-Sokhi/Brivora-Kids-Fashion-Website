...
<head>
  ...
  <title>{{ $title ?? 'Brivora Kids Fashion' }}</title>
  ...
  <style>
    ...
    margin: 0;
    padding: 0;
    background: linear-gradient(135deg, #eb0707, #e6f7ff); /* pastel gradient background */
  }
  header {
    background: #1477b5;
    color: white;
